...
from mgi.models import Template, Instance, TemplateVersion, OaiRecord, OaiMetadataFormat, OaiRegistry, XMLdata, unparse
    ...
    if len(instanceResults) > 0:
        ...
        if not onlySuggestions:
            ...
            for instanceResult in instanceResults[:20]:
                ...
                listWholeKeywords = re.findall("\\b("+ wordList +")\\b", unparse(instanceResult['metadata']).encode('utf-8'), flags=re.IGNORECASE)
